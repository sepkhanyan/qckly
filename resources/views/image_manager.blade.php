...
<head>
    ...
    <link href="{{asset('css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" id="bootstrap-css">
    <link href="{{ asset('css/font-awesome.min.css') }}" rel="stylesheet" id="font-awesome-css">
    <link href="{{ asset('css/metisMenu.min.css') }}" rel="stylesheet" type="text/css" id="metis-menu-css">
    <link href="{{ asset('css/select2.css') }}" rel="stylesheet" type="text/css" id="select2-css">
    <link href="{{ asset('css/select2-bootstrap.css') }}" rel="stylesheet" type="text/css" id="select2-bootstrap-css">
    <link href="{{ asset('css/dropzone.min.css') }}" rel="stylesheet" type="text/css" id="dropzone-css">
    <link href="{{ asset('css/fonts.css') }}" rel="stylesheet" type="text/css" id="fonts-css">
    <link href="{{ asset('css/image-manager.css') }}" rel="stylesheet" type="text/css" id="image-manager-css">
    <script src="{{ asset('js/jquery-1.11.2.min.js') }}" type="text/javascript" id="jquery-js"></script>
    <script src="{{ asset('js/bootstrap.min.js') }}" type="text/javascript" id="bootstrap-js"></script>
    <script src="{{ asset('js/js.cookie.js')}}" type="text/javascript" id="js-cookie-js"></script>
    <script src="{{ asset('js/metisMenu.min.js') }}" type="text/javascript" id="metis-menu-js"></script>
    <script src="{{ asset('js/bootbox.js') }}" type="text/javascript" id="bootbox-js"></script>
    <script src="{{ asset('js/select2.js') }}" type="text/javascript" id="select-2-js"></script>
    <script src="{{ asset('js/dropzone.min.js') }}" type="text/javascript" id="dropzone-js"></script>
    <script src="{{ asset('js/selectonic.min.js') }}" type="text/javascript" id="selectonic-js"></script>
    <script src="{{ asset('js/common.js') }}" type="text/javascript" id="common-js"></script>
...
<body>
<div class="notification alert alert-info" style="display:none;">
    <span data-original-title="" title=""></span>
</div>
<input type="hidden" id="current_url" value="{{url('/image/manager')}}?popup=iframe&amp;field_id=field&amp;sub_folder=">
...
<input type="hidden" id="field_id" value="field">
...
<nav class="navbar navbar-default navbar-menu" role="navigation">
    <div class="container-fluid navbar-fixed-top">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" data-original-title="" title="">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <div class="btn-toolbar" role="toolbar">
                <div class="col-xs-12 col-sm-2 wrap-none">
                    <div class="btn-group">
                        <a class="btn btn-default navbar-btn btn-back Disabled" title="" href="" data-original-title="Back">
                            <i class="fa fa-arrow-left"></i>
                        </a>
                        <a id="refresh" title="" class="btn btn-default navbar-btn btn-refresh" href="{{url('/image/manager')}}?popup=iframe&amp;field_id=field&amp;sub_folder=&amp;5b30d22fb4e40" data-original-title="Refresh">
                ...
                <div class="col-xs-12 col-sm-4 wrap-none">
                    <div class="btn-group">
                        <button type="button" class="btn btn-default navbar-btn btn-upload" data-original-title="" title="">
                ...
                <div class="col-xs-2 col-sm-1 wrap-none">
                    <div class="btn-group">
                        <a class="btn btn-default navbar-btn btn-options" title="" href="qckly.loc/settings#image-manager" target="_parent" data-original-title="Options">
                ...
                <div class="col-xs-2 col-sm-1 wrap-none">
                    <div class="btn-group">
                        <div class="dropdown">
                            <a class="btn btn-default navbar-btn btn-sort dropdown-toggle" data-toggle="dropdown" title="" data-original-title="Sort">
                            ...
                            <ul class="dropdown-menu dropdown-sorter" role="menu">
                                ...
                                <li class="divider"></li>
                                <li>
                                    <a class="sorter" data-sort="name" data-original-title="" title="">
                                        <i class="fa fa-caret-up"></i>Name
                                    </a>
                                </li>
                                <li>
                ...
                <div class="col-xs-8 col-sm-4 wrap-none">
                    <div class="btn-group btn-block">
                        <div class="navbar-form input-group">
                            <span id="btn-clear" class="input-group-addon" title="" data-original-title="Clear">
                                <i id="filter-clear" class="fa fa-times"></i>
                            </span>
                            <input type="text" name="filter_search" id="filter-search" class="form-control" value="" placeholder="Search files and folders...">
                            <span id="btn-search" class="input-group-addon" title="" data-original-title="Search">
        ...
        <ol class="breadcrumb">
            <li id="folderPopover">
                <button type="button" class="btn btn-folders" data-container="body" data-placement="bottom" data-toggle="popover" data-original-title="" title="">
            ...
            <li>
                <a class="btn btn-new-folder" title="" href="#" data-original-title="New Folder">
                    <i class="fa fa-folder"></i>
                </a>&nbsp;&nbsp;&nbsp;
                <a class="btn btn-rename" title="" data-name="" data-path="/" href="#" data-original-title="Rename Folder">
                    <i class="fa fa-pencil"></i>
                </a>&nbsp;&nbsp;&nbsp;
                <a class="btn btn-delete" title="" data-name="" data-path="/" href="#" data-original-title="Delete Folder">
    ...
    <div class="row-fluid">
        ...
        <div class="uploader-box">
            <div class="tabbable upload-tabbable">
                <form role="form" method="POST" enctype="multipart/form-data" id="my-awesome-dropzone" class="dropzone dz-clickable">
            ...
            <div id="selectable" class="col-xs-9 wrap-none">
                ...
                <div class="media-list row selectable">
                    ...
                    <div class="thumbnail-each col-xs-6 col-sm-4 ff-item-type-2 file">
                        <figure class="thumbnail" data-type="img" data-name="" data-path="">
                            <a class="link" title="" data-original-title="29 KB">
                                <div class="img-container">
                                    <img alt="" class="img-responsive thumb" src="/images/{{$location->location_image}}">
                                </div>
                                <figcaption class="caption">
                                    <h4 class="ellipsis">
                                        <span class="" data-original-title="" title=""></span>
                                    </h4>
                                </figcaption>
                            </a>
                            <div class="info">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default btn-preview" title="" data-url="" data-original-title="Preview">
                                        <i class="fa fa-eye"></i>
                                    </button>
                                    <button type="button" class="btn btn-default btn-rename" title="" data-name="" data-path="" data-original-title="Rename">
                                        <i class="fa fa-pencil"></i>
                                    </button>
                                    <button type="button" class="btn btn-default btn-move" title="" data-original-title="Move">
                                        <i class="fa fa-folder-open"></i>
                                    </button>
                                    <button type="button" class="btn btn-default btn-copy" title="" data-original-title="Copy">
                                        <i class="fa fa-clipboard"></i>
                                    </button>
                                    <button type="button" class="btn btn-default btn-delete" title="" data-original-title="Delete">
                                        <i class="fa fa-trash"></i>
                                    </button>
                                </div>
                                <ul class="get_info">
                                    <li class="file-name">
                                        <span data-original-title="" title="">Name :</span>
                                    </li>
                                    <li class="file-size">
                                        <span data-original-title="" title="">Size :</span>
                                    </li>
                                    <li class="file-path">
                                        <span data-original-title="" title="">Path :</span> /
                                    </li>
                                    <li class="file-url">
                                        <span data-original-title="" title="">URL :</span>
                                        <input type="text" class="form-control url-control" readonly="readonly" value="">
                                    </li>
                                    <li class="img-dimension">
                                        <span data-original-title="" title="">Dimension :</span>
                                    </li>
                                    <li class="file-date">
                                        <span data-original-title="" title="">Modified Date :</span>
                                    </li>
                                    <li class="file-extension">
                                        <span data-original-title="" title="">Extension :</span>
                                        <em class="text-uppercase"></em>
                                    </li>
...
<nav class="navbar navbar-default navbar-statusbar navbar-fixed-bottom" role="navigation">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-4">
                <p class="navbar-text">
                    <span class="total-selected" data-original-title="" title="">0</span>
                    <span class="total-selected-text" data-original-title="" title=""> of </span>54 items selected, 6 MB
                </p>
            </div>
            <div class="col-sm-4 text-right">
                <a class="btn btn-primary btn-choose disabled" data-original-title="" title="">Choose</a>
            </div>
        </div>
    </div>
</nav>
...
<script type="text/javascript"><!--
    $(document).ready(function () {
        ...
        var folder_tree = '<nav class="nav">' +
            '<ul class="metisFolder" role="menu">' +
            '<li class="directory">' +
            '<a href="qckly.loc/image_manager?popup=iframe&field_id=field&sub_folder=/flags/&5b30d22fbba78">' +
            '<i class="fa fa-folder-open"></i> flags' +
            '</a>' +
            '<ul>' +
            '</ul>' +
            '</li>' +
            '<li class="directory">' +
            '<a href="qckly.loc/image_manager?popup=iframe&field_id=field&sub_folder=/gallery/&5b30d22fbba78">' +
            '<i class="fa fa-folder-open"></i> gallery' +
            '</a>' +
            '<ul>' +
            '<li class="directory">' +
            '<a href="qckly.loc/image_manager?popup=iframe&field_id=field&sub_folder=/gallery/lewisham/&5b30d22fbba78">' +
            '<i class="fa fa-folder-open"></i> lewisham' +
            '</a>' +
            '<ul>' +
            '</ul>' +
            '</li>' +
            ...
            '</li>' +
            '<li class="directory">' +
            '<a href="qckly.loc/image_manager?popup=iframe&field_id=field&sub_folder=/newtest/&5b30d22fbba78">' +
            '<i class="fa fa-folder-open"></i> newtest' +
            '</a>' +
            '<ul>' +
            '<li class="directory">' +
            '<a href="qckly.loc/image_manager?popup=iframe&field_id=field&sub_folder=/newtest/testfolder/&5b30d22fbba78">' +
            '<i class="fa fa-folder-open"></i> testfolder' +
            '</a>' +
            '<ul>' +
            '</ul>' +
            '</li>' +
