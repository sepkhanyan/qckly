...
@section('content')
        ...
        <div class="col-md-12">
            <div class="panel panel-default panel-table">
                ...
                <div class="panel-body panel-filter" style="display: none">
                    <form role="form" id="filter-form" accept-charset="utf-8" method="GET" action="{{url('/statuses')}}">
                        <div class="filter-bar">
                            <div class="form-inline">
                                <div class="row">
                                    <div class="col-md-8 pull-left">
                                        <div class="form-group">
                                            <input type="text" name="status_search" class="form-control input-sm" value="" placeholder="Search status." />&nbsp;&nbsp;&nbsp;
                                        </div>
                            ...
                            @foreach($statuses as $status)
                                <tr>
                                    <td class="action">
                                        ...
                                        <a  class="btn btn-edit"   data-toggle="modal" data-target="#modalEditStatus"  type="button"   onclick="myFunction({{$status->id}})">
    ...
    <div class="modal fade" id="modalCreateStatus" role="dialog" tabindex="-1" >
        <form role="form" id="create-form" class="form-horizontal"  accept-charset="utf-8" method="GET" action="{{ url('/status/store') }}">
            {{ csrf_field() }}
            <div class="modal-dialog" >
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group {{ $errors->has('name_en') ? ' has-error' : '' }}" style="margin: 5px">
                    ...
                    <div class="modal-body">
                        <div class="form-group {{ $errors->has('name_ar') ? ' has-error' : '' }}" style="margin: 5px">
