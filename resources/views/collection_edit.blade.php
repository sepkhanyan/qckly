                                ...
                                <div id="selection">
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            @foreach($menu_categories as $menu_category)
                                                ...
                                                <label for="menu_min_qty">
                                                    <input type="text" class="form-control" name="menu_min_qty[]"
                                                           id="menu_min_qty" placeholder="Menu Min Quantity" value="">
                                                </label>
                                                <label for="menu_max_qty">
                                                    <input type="text" class="form-control" name="menu_max_qty[]"
                                                           id="menu_max_qty" placeholder="Menu Max Quantity" value="">
                                                </label>
                                    ...
                                    <div style="display: none" id="setup">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group">
                                                    <input type="text" name="setup_time" id="input-setup"
                                                           class="form-control" value="{{$collection->setup_time}}"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group">
                                                    <input type="text" name="max_time" id="input-max"
                                                           class="form-control" value="{{$collection->max_time}}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
