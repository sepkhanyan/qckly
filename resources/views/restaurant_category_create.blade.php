...
@section('content')
    ...
    <div class="row content">
        <div class="col-md-12">
            ...
            <form role="form" id="edit-form" class="form-horizontal" accept-charset="utf-8" method="POST" action="{{ url('/restaurant_category/store') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="tab-content">
                    <div id="general" class="tab-pane row wrap-all active">
                        <div class="form-group{{ $errors->has('name_en') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="name_en" id="input-name" class="form-control" value="{{ old('name_en') }}">
                        ...
                        <div class="form-group{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="name_ar" id="input-name" class="form-control" value="{{ old('name_ar') }}">
