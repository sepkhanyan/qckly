                                ...
                                {{--<div class="row">--}}
                                    {{--<div class="col-md-8 pull-left">--}}
                                        {{--<div class="form-group">--}}
                                            {{--<input type="text" name="mealtime_search" class="form-control input-sm" value="" placeholder="Search mealtime." />&nbsp;&nbsp;&nbsp;--}}
                                        {{--</div>--}}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group" style="margin: 5px">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="mealtime_en" class="form-control" value="" id="mealtime-en">
                            </div>
                        </div>
                    </div>
                    <div class="modal-body">
                        <div class="form-group" style="margin: 5px">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="mealtime_ar" class="form-control" value="" id="mealtime-ar">
                            </div>
                        </div>
                    </div>
                    <div class="modal-body">
