...
@section('content')
    ...
    <div class="row content">
        <div class="col-md-12">
            ...
            <form role="form" id="edit-form" class="form-horizontal" accept-charset="utf-8" method="POST" action="{{ url('/restaurant_category/update/' . $category->restaurant_category_id) }}">
                {{ csrf_field() }}
