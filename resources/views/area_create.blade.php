                ...
                <div class="tab-content">
                    <div id="general" class="tab-pane row wrap-all active">
                        <div class="form-group{{ $errors->has('area_en') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="area_en" class="form-control" value="{{ old('area_en') }}" id="area-en" style="width: 50%" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('area_ar') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="area_ar" class="form-control" value="{{ old('area_ar') }}" id="area-en" style="width: 50%" required autofocus>
