                    ...
                    <div class="table-responsive">
                        <table border="0" class="table table-striped table-border">
                            ...
                            <tr>
                                ...
                                <th><a class="sort" href="">First Name<i class="fa fa-sort"></i></a></th>
                                <th><a class="sort" href="">Last Name<i class="fa fa-sort>"></i></a></th>
                                <th><a class="sort" href="">Email<i class="fa fa-sort"></i></a></th>
                                <th>Telephone</th>
                                <th><a class="sort" href="">Date Registered<i class="fa fa-sort-"></i></a></th>
                                <th class="text-center">Status</th>
                                <th class="id"><a class="sort" href="">ID<i class="fa fa-sort-"></i></a></th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            @foreach($users as $user)
                                <tr>
                                    <td class="action"><input type="checkbox" value="{{$user->user_id}}" name="delete" />&nbsp;&nbsp;&nbsp;
                                        <a class="btn btn-edit" title="" href="{{ url('customer/edit/' . $user->user_id )}}"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
                                        <a class="btn btn-info " title=""  ><i class="fa fa-user"></i>&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></a>
                                    </td>
                                    <td></td>
                                    <td></td>
                                    <td>{{$user->email}}</td>
