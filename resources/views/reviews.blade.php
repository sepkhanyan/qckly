                                ...
                                <select name="restaurant_name" id="input-name" class="form-control" tabindex="-1"
                                    ...
                                    @if($selectedRestaurant)
                                        @foreach($restaurants as $restaurant)
                                                <option value="{{url('/reviews/' . $restaurant->id)}}"{{($restaurant->id == $selectedRestaurant->id) ? 'selected' : ''}}>{{$restaurant->name_en . ', ' . $restaurant->area->area_en . ', ' . $restaurant->address_en}}</option>
                                        @endforeach
                                    @else
