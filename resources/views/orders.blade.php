                                ...
                                <div class="row">
                                    <div class="col-md-3 pull-right text-right">
                                        <div class="form-group">
                                            <input type="text" name="order_search" class="form-control input-sm" value="" placeholder="Search order id, restaurant or customer." />&nbsp;&nbsp;&nbsp;
                                        </div>
                                    ...
                                    <div class="col-md-8 pull-left">
                                        <div class="form-group">
                                            <select name="order_restaurant" class="form-control input-sm">
