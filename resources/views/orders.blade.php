                                ...
                                <select name="restaurant_name" id="restaurant" class="form-control" tabindex="-1"
                                    ...
                                    @if($selectedRestaurant)
                                        @foreach($restaurants as $restaurant)
                                                <option value="{{url('/orders/' . $restaurant->id)}}"{{($restaurant->id == $selectedRestaurant->id) ? 'selected' : ''}}>{{$restaurant->name_en . ', ' . $restaurant->area->area_en . ', ' . $restaurant->address_en}}</option>
                                        @endforeach
                                    @else
