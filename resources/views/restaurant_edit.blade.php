                ...
                <form role="form" id="edit-form" name="edit_form" class="form-horizontal" accept-charset="utf-8"
                    ...
                    <div class="tab-content">
                        ...
                        <div id="opening-hours" class="tab-pane row wrap-all">
                                ...
                                <div class="col-sm-5">
                                    <div class="table-responsive">
                                        <table border="0" class="table table-striped table-border">
                                            ...
                                            @endif
                                            <td class="action">
                                                <label class=" btn btn-primary " id="editWorkingHour">
                                                    <i class="fa fa-pencil"></i>
                                                </label>
                                            </td>
                                        </table>
                            ...
                            <div style="display: none{{(old('opening_type') ? 'block' : '')}}" id="editing_working_hour">
                                ...
                                <div class="form-group" >
                                    <label  class="col-sm-3 control-label text-right"></label>
                                    <div class="col-sm-5">
                                        <label class=" btn btn-danger " id="editWorkingHourCancel">
                                            Cancel
                                        </label>
                                    </div>
                                </div>
