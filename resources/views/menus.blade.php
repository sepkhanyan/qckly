                                ...
                                <select name="restaurant_name" id="restaurant" class="form-control" tabindex="-1"
                                    ...
                                    @if($selectedRestaurant)
                                        @foreach($restaurants as $restaurant)
                                                <option value="{{url('/menus/' . $restaurant->id)}}"{{($restaurant->id == $selectedRestaurant->id) ? 'selected' : ''}}>{{$restaurant->name_en . ', ' . $restaurant->area->name_en . ', ' . $restaurant->address_en}}</option>
                                        @endforeach
                                    @else
                                        <option value>Select Restaurant</option>
                                        @foreach($restaurants as $restaurant)
                                            <option value="{{url('/menus/' . $restaurant->id)}}">{{$restaurant->name_en . ', ' . $restaurant->area->name_en . ', ' . $restaurant->address_en}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
