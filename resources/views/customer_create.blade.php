...
@section('content')
    <div class="page-header clearfix">
        <div class="page-action">
            ...
            <a href="{{ url('/customers') }}" class="btn btn-default">
...
<div class="row content">
    <div class="col-md-12">
        ...
        <form role="form" id="edit-form" class="form-horizontal" accept-charset="utf-8" method="GET" action="{{ url('/customer/store') }}">
            {{ csrf_field() }}
            <div class="tab-content">
                <div id="general" class="tab-pane row wrap-all active">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="name" id="input_name" class="form-control" value="" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input_email" class="col-sm-3 control-label">Email</label>
                        <div class="col-sm-5">
                            <input type="text" name="email" id="input_email" class="form-control" value="" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input_telephone" class="col-sm-3 control-label">Telephone</label>
                        <div class="col-sm-5">
                            <input type="text" name="telephone" id="input_telephone" class="form-control" value="" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    {{--</div>--}}
                    {{--<div class="form-group">--}}
                        {{--<label for="input-customcustomers-id" class="col-sm-3 control-label">Customer Group</label>--}}
                        {{--<div class="col-sm-5">--}}
                            {{--<select name="customer_group_id" id="input-customcustomers-id" class="form-control">--}}
