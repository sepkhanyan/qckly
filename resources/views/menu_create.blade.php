...
@section('content')
    ...
    <div class="row content">
        <div class="col-md-12">
            ...
            <form role="form" id="edit-form" class="form-horizontal" enctype="multipart/form-data" accept-charset="utf-8" method="POST" action="{{ url('/menu/store') }}" >
                {{ csrf_field() }}
                <div class="tab-content">
                    <div id="general" class="tab-pane row wrap-all active">
                        ...
                        <div class="form-group{{ $errors->has('menu_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="menu_name" id="input-name" class="form-control" value="{{ old('menu_name') }}">
                        ...
                        <div class="form-group{{ $errors->has('menu_description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <textarea name="menu_description" id="input-description" class="form-control" rows="5">{{ old('menu_description') }}</textarea>
                    ...
                    <div id="menu-details" class="tab-pane row wrap-all">
                        ...
                        <div class="form-group{{ $errors->has('menu_priority') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="menu_priority" id="input-menu-priority" class="form-control" value="{{ old('menu_priority') }}" />
