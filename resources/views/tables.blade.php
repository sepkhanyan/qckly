...
@section('content')
    <div class="page-header">
        <div class="page-action">
            <a href="" data-toggle="modal" data-target="#addCost" class="btn btn-primary">
                    ...
                    <div class="table-responsive">
                        <table border="0" class="table table-striped table-border">
                            ...
                            @foreach($tables as $table)
                                <tr>
                                    <td class="action"><input type="checkbox" value="" name="delete[]" />&nbsp;&nbsp;&nbsp;
                                        <a class="btn btn-edit" title="" href=""><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
                                    </td>
