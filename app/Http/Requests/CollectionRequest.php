...
class CollectionRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'food_list_en.required' => 'The Foodlist En: field is required.',
            'food_list_en.string'  => 'The Foodlist En: must be a string.',
            'food_list_ar.required' => 'The Foodlist Ar: field is required.',
            'food_list_ar.string'  => 'The Foodlist Ar: must be a string.',
            'container_title_en.required' => 'The Title En: field is required.',
            'container_title_en.string'  => 'The Title En: must be a string.',
            'container_title_ar.required' => 'The Title Ar: field is required.',
            'container_title_ar.string'  => 'The Title Ar: must be a string.',
    ...
    public function rules()
    {
        $rules = [
            ...
            'menu' => 'required|array',
            'food_list_en' => 'required|string',
            'food_list_ar' => 'required|string',
            'container_title_en' => 'required|string',
            'container_title_ar' => 'required|string',
