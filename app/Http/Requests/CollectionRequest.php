...
class CollectionRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'daily_hours.start.date_format' => 'The Start Time: does not match the format H:i.',
            'daily_hours.end.required' => 'The End Time: field is required.',
            'daily_hours.end.date_format' => 'The End Time: does not match the format H:i.',
            ...
            'flexible_hours.1.start.date_format' => 'The Start Time: does not match the format H:i.',
            'flexible_hours.1.end.required' => 'The End Time: field is required.',
            'flexible_hours.1.end.date_format' => 'The End Time: does not match the format H:i.',
            ...
            'flexible_hours.2.start.date_format' => 'The Start Time: does not match the format H:i.',
            'flexible_hours.2.end.required' => 'The End Time: field is required.',
            'flexible_hours.2.end.date_format' => 'The End Time: does not match the format H:i.',
            ...
            'flexible_hours.3.start.date_format' => 'The Start Time: does not match the format H:i.',
            'flexible_hours.3.end.required' => 'The End Time: field is required.',
            'flexible_hours.3.end.date_format' => 'The End Time: does not match the format H:i.',
            ...
            'flexible_hours.4.start.date_format' => 'The Start Time: does not match the format H:i.',
            'flexible_hours.4.end.required' => 'The End Time: field is required.',
            'flexible_hours.4.end.date_format' => 'The End Time: does not match the format H:i.',
            ...
            'flexible_hours.5.start.date_format' => 'The Start Time: does not match the format H:i.',
            'flexible_hours.5.end.required' => 'The End Time: field is required.',
            'flexible_hours.5.end.date_format' => 'The End Time: does not match the format H:i.',
            ...
            'flexible_hours.6.start.date_format' => 'The Start Time: does not match the format H:i.',
            'flexible_hours.6.end.required' => 'The End Time: field is required.',
            'flexible_hours.6.end.date_format' => 'The End Time: does not match the format H:i.',
            ...
            'flexible_hours.0.start.date_format' => 'The Start Time: does not match the format H:i.',
            'flexible_hours.0.end.required' => 'The End Time: field is required.',
            'flexible_hours.0.end.date_format' => 'The End Time: does not match the format H:i.',
        ...
        if($this->has('is_available') && $this->is_available == 0){
            if($this->type == 'daily'){
                $rules = [
                    ...
                    'daily_hours.start' => 'required|date_format:H:i',
                    'daily_hours.end' => 'required|date_format:H:i|after:daily_hours.start'
                ];
            }
            if($this->type == 'flexible'){
                $rules = [
                    'flexible_hours.1.start' => 'required|date_format:H:i',
                    'flexible_hours.1.end' => 'required|date_format:H:i|after:flexible_hours.1.start',
                    'flexible_hours.2.start' => 'required|date_format:H:i',
                    'flexible_hours.2.end' => 'required|date_format:H:i|after:flexible_hours.2.start',
                    'flexible_hours.3.start' => 'required|date_format:H:i',
                    'flexible_hours.3.end' => 'required|date_format:H:i|after:flexible_hours.3.start',
                    'flexible_hours.4.start' => 'required|date_format:H:i',
                    'flexible_hours.4.end' => 'required|date_format:H:i|after:flexible_hours.4.start',
                    'flexible_hours.5.start' => 'required|date_format:H:i',
                    'flexible_hours.5.end' => 'required|date_format:H:i|after:flexible_hours.5.start',
                    'flexible_hours.6.start' => 'required|date_format:H:i',
                    'flexible_hours.6.end' => 'required|date_format:H:i|after:flexible_hours.6.start',
                    'flexible_hours.0.start' => 'required|date_format:H:i',
                    'flexible_hours.0.end' => 'required|date_format:H:i|after:flexible_hours.0.start'
                ];
            }
        }
