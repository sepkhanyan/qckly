...
class CollectionRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'delivery_time.integer'  => 'The Delivery Time: field must be an integer.',
            'delivery_time.gt'  => 'The Delivery Time: field must be greater than 0.',
            ...
            'menu_item.array' => 'The Menu Item: field must be an array.',
            'collection_price.required_unless'  => 'The Collection Price: field is required.',
            'collection_price.numeric'  => 'The Collection Price: field must be a number.',
            'min_quantity.required_if'  => 'The Min Quantity: field is required.',
            'min_quantity.integer'  => 'The Min Quantity: field must be an integer.',
            'min_quantity.gt'  => 'The Min Quantity: field must be greater than 0.',
            'max_quantity.required_if'  => 'The Max Quantity: field is required.',
            'max_quantity.integer'  => 'The Max Quantity: field must be an integer.',
            'max_quantity.gte'  => 'The Max Quantity: field must be greater than or equal Min Quantity: field.',
            'min_serve_to_person.required_if'  => 'The Min Serve to Person: field is required.',
            'min_serve_to_person.integer'  => 'The Min Serve to Person: field must be an integer.',
            'min_serve_to_person.gt'  => 'The Min Serve to Person: field must be greater than 0.',
            'max_serve_to_person.required_if'  => 'The Max Serve to Person: field is required.',
            'max_serve_to_person.integer'  => 'The Max Serve to Person: field must be an integer.',
            'max_serve_to_person.gte'  => 'The Max Serve to Person: field must be greater than or equal Min Serve to Person: field.',
            ...
            'setup_time.integer'  => 'The Setup Time: field must be an integer.',
            'setup_time.gt'  => 'The Setup Time: field must be greater than 0.',
            'max_time.required_if'  => 'The Max Time: field is required.',
            'max_time.integer'  => 'The Max Time: field must be an integer.',
            'max_time.gte'  => 'The Max Time: field must be greater than or equal Min Quantity: field.',
            ...
            'daily_days.array' => 'The Daily Days: field must be an array.',
